...
Devise.setup do |config|
  ...
  # The User model declares `:lockable` so the columns exist; without the
  # config below the strategy is :none → no brute-force protection on
  # /users/sign_in. Self-hosted DocuSeal exposes that endpoint publicly
  # at docuseal.<apex>, so lock the account on 10 wrong attempts and
