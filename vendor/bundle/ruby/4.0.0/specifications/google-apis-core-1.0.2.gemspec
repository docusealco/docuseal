# -*- encoding: utf-8 -*-
# stub: google-apis-core 1.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<addressable>.freeze, ["~> 2.8".freeze, ">= 2.8.7".freeze])
