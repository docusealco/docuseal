...
DEF_NARRAY_EACH_METHOD_FUNC(int16)
DEF_NARRAY_MAP_METHOD_FUNC(int16, numo_cInt16)
DEF_NARRAY_EACH_WITH_INDEX_METHOD_FUNC(int16)
DEF_NARRAY_MAP_WITH_INDEX_METHOD_FUNC(int16, numo_cInt16)
DEF_NARRAY_ABS_METHOD_FUNC(int16, numo_cInt16, int16, numo_cInt16)
...
DEF_NARRAY_POW_METHOD_FUNC(int16, numo_cInt16)
DEF_NARRAY_MINUS_METHOD_FUNC(int16, numo_cInt16)
DEF_NARRAY_RECIPROCAL_METHOD_FUNC(int16, numo_cInt16)
DEF_NARRAY_SIGN_METHOD_FUNC(int16, numo_cInt16)
DEF_NARRAY_SQUARE_METHOD_FUNC(int16, numo_cInt16)
...
DEF_NARRAY_INT_ARGMAX_METHOD_FUNC(int16)
DEF_NARRAY_INT_ARGMIN_METHOD_FUNC(int16)
...
DEF_NARRAY_INT_SEQ_METHOD_FUNC(int16)
...
static void int16_free(void* ptr) {
...
static VALUE int16_s_alloc_func(VALUE klass) {
...
void Init_numo_int16(void) {
   ...
   */
  rb_define_method(cT, "stddev", int16_stddev, -1);
  /**
   * rms of self.
   ...
   */
  rb_define_method(cT, "rms", int16_rms, -1);
}
