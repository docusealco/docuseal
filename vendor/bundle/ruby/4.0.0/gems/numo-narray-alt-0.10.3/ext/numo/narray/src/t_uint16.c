...
DEF_NARRAY_STORE_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_S_CAST_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_EXTRACT_METHOD_FUNC(uint16)
DEF_NARRAY_AREF_METHOD_FUNC(uint16)
DEF_EXTRACT_DATA_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_ASET_METHOD_FUNC(uint16)
...
DEF_NARRAY_GE_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_LT_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_LE_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_BIT_AND_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_BIT_OR_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_BIT_XOR_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_BIT_NOT_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_LEFT_SHIFT_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_RIGHT_SHIFT_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_CLIP_METHOD_FUNC(uint16, numo_cUInt16)
...
DEF_NARRAY_INT_MIN_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_MAX_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_PTP_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_MAX_INDEX_METHOD_FUNC(uint16)
DEF_NARRAY_INT_MIN_INDEX_METHOD_FUNC(uint16)
DEF_NARRAY_INT_ARGMAX_METHOD_FUNC(uint16)
DEF_NARRAY_INT_ARGMIN_METHOD_FUNC(uint16)
...
#undef qsort_dtype
#define qsort_dtype uint16
#undef qsort_cast
#define qsort_cast *(uint16*)
DEF_NARRAY_INT_SORT_METHOD_FUNC(uint16)
#undef qsort_dtype
#define qsort_dtype uint16*
#undef qsort_cast
#define qsort_cast **(uint16**)
DEF_NARRAY_INT_SORT_INDEX_METHOD_FUNC(uint16, numo_cUInt16)
DEF_NARRAY_INT_MEDIAN_METHOD_FUNC(uint16)
...
static size_t uint16_memsize(const void* ptr) {
...
static void uint16_free(void* ptr) {
...
static VALUE uint16_s_alloc_func(VALUE klass) {
...
static VALUE uint16_allocate(VALUE self) {
  narray_t* na;
  char* ptr;
