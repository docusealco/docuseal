...
DEF_NARRAY_INT_MIN_METHOD_FUNC(uint32, numo_cUInt32)
DEF_NARRAY_INT_MAX_METHOD_FUNC(uint32, numo_cUInt32)
DEF_NARRAY_INT_PTP_METHOD_FUNC(uint32, numo_cUInt32)
DEF_NARRAY_INT_MAX_INDEX_METHOD_FUNC(uint32)
DEF_NARRAY_INT_MIN_INDEX_METHOD_FUNC(uint32)
DEF_NARRAY_INT_ARGMAX_METHOD_FUNC(uint32)
DEF_NARRAY_INT_ARGMIN_METHOD_FUNC(uint32)
...
void Init_numo_uint32(void) {
   ...
   */
  rb_define_method(cT, "argmax", uint32_argmax, -1);
  /**
   * Index of the minimum value.
   ...
   */
  rb_define_method(cT, "argmin", uint32_argmin, -1);
  /**
   * minmax of self.
   ...
   */
  rb_define_method(cT, "stddev", uint32_stddev, -1);
  /**
   * rms of self.
   ...
   */
  rb_define_method(cT, "rms", uint32_rms, -1);
}
