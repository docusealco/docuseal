...
DEF_NARRAY_STORE_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_S_CAST_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_EXTRACT_METHOD_FUNC(int64)
DEF_NARRAY_AREF_METHOD_FUNC(int64)
DEF_EXTRACT_DATA_FUNC(int64, numo_cInt64)
DEF_NARRAY_ASET_METHOD_FUNC(int64)
DEF_NARRAY_COERCE_CAST_METHOD_FUNC(int64)
DEF_NARRAY_TO_A_METHOD_FUNC(int64)
DEF_NARRAY_FILL_METHOD_FUNC(int64)
DEF_NARRAY_FORMAT_METHOD_FUNC(int64)
DEF_NARRAY_FORMAT_TO_A_METHOD_FUNC(int64)
DEF_NARRAY_INSPECT_METHOD_FUNC(int64)
DEF_NARRAY_EACH_METHOD_FUNC(int64)
DEF_NARRAY_MAP_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_EACH_WITH_INDEX_METHOD_FUNC(int64)
DEF_NARRAY_MAP_WITH_INDEX_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_ABS_METHOD_FUNC(int64, numo_cInt64, int64, numo_cInt64)
DEF_NARRAY_ADD_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_SUB_METHOD_FUNC(int64, numo_cInt64)
...
DEF_NARRAY_INT64_POW_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_MINUS_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_RECIPROCAL_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_SIGN_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_SQUARE_METHOD_FUNC(int64, numo_cInt64)
...
DEF_NARRAY_GE_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_LT_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_LE_METHOD_FUNC(int64, numo_cInt64)
...
DEF_NARRAY_INT_LEFT_SHIFT_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_INT_RIGHT_SHIFT_METHOD_FUNC(int64, numo_cInt64)
...
DEF_NARRAY_INT_BINCOUNT_METHOD_FUNC(int64, numo_cInt64)
...
DEF_NARRAY_POLY_METHOD_FUNC(int64, numo_cInt64)
#undef qsort_dtype
#define qsort_dtype int64
#undef qsort_cast
#define qsort_cast *(int64*)
DEF_NARRAY_INT_SORT_METHOD_FUNC(int64)
#undef qsort_dtype
#define qsort_dtype int64*
#undef qsort_cast
#define qsort_cast **(int64**)
DEF_NARRAY_INT_SORT_INDEX_METHOD_FUNC(int64, numo_cInt64)
DEF_NARRAY_INT_MEDIAN_METHOD_FUNC(int64)
...
static size_t int64_memsize(const void* ptr) {
...
static void int64_free(void* ptr) {
...
static VALUE int64_s_alloc_func(VALUE klass) {
