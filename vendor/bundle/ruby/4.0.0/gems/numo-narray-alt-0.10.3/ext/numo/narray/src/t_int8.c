...
DEF_NARRAY_ASET_METHOD_FUNC(int8)
...
DEF_NARRAY_EACH_METHOD_FUNC(int8)
DEF_NARRAY_MAP_METHOD_FUNC(int8, numo_cInt8)
DEF_NARRAY_EACH_WITH_INDEX_METHOD_FUNC(int8)
DEF_NARRAY_MAP_WITH_INDEX_METHOD_FUNC(int8, numo_cInt8)
DEF_NARRAY_ABS_METHOD_FUNC(int8, numo_cInt8, int8, numo_cInt8)
...
DEF_NARRAY_POLY_METHOD_FUNC(int8, numo_cInt8)
#undef qsort_dtype
#define qsort_dtype int8
#undef qsort_cast
#define qsort_cast *(int8*)
DEF_NARRAY_INT_SORT_METHOD_FUNC(int8)
#undef qsort_dtype
#define qsort_dtype int8*
#undef qsort_cast
#define qsort_cast **(int8**)
DEF_NARRAY_INT_SORT_INDEX_METHOD_FUNC(int8, numo_cInt8)
DEF_NARRAY_INT_MEDIAN_METHOD_FUNC(int8)
...
static size_t int8_memsize(const void* ptr) {
...
static void int8_free(void* ptr) {
...
static VALUE int8_s_alloc_func(VALUE klass) {
